...
class InfiniteGridMenu {
  ...
  discBuffers!: { vertices: Float32Array; indices: Uint16Array; normals: Float32Array; uvs: Float32Array };
    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          <h3
            className={`
              select-none absolute font-bold text-2xl md:text-3xl lg:text-4xl
          ...
          <p
            className={`
              select-none absolute max-w-[12ch] text-sm md:text-base lg:text-lg
          ...
          {activeItem.link && (
            <div
              ...
              className={`
                ...
                hover:bg-foreground/30 hover:scale-110
                transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
                ${isMoving 
                  ? 'bottom-4 opacity-0 pointer-events-none duration-100 scale-75' 
                  : 'bottom-8 opacity-100 pointer-events-auto duration-500 scale-100'
                }
              `}
            >
              <span className="select-none text-foreground text-xl md:text-2xl">↗</span>
            </div>
          )}
        </>
      )}
